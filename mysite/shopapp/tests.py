...
class ProductDetailViewTestCase(TestCase):
    ...
    def test_product_view_reviews(self):
        ...
        data = {"author": "George",
                ...
                "text": "Hie ",
                "rate": 5}
        response = self.client.post(reverse("shopapp:product_review", args=[1]), data=data)
...
class OrderPostViewTestCase(TestCase):
    ...
    def test_order_details_post(self):
        ...
        response = self.client.post(reverse("shopapp:orders_details", args=[1]), data=data)
