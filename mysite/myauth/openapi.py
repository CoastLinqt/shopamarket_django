...
password_input = openapi.Schema(
    ...
    properties={
        'passwordCurrent': openapi.Schema(type=openapi.TYPE_STRING, description='passwordCurrent',),
        'password': openapi.Schema(type=openapi.TYPE_STRING, description='password'),
        'passwordReply': openapi.Schema(type=openapi.TYPE_STRING, description='passwordReply'),
    }
)
