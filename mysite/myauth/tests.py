...
class ProfileViewTestCase(TestCase):
    ...
    def test_sign_up(self):
        ...
        response = self.client.post(
            reverse("myauth:sign-up"), data=data, content_type="application/json"
        )
    ...
    def test_sign_in(self):
        ...
        response = self.client.post(
            reverse("myauth:sign-in"), data=data, content_type="application/json"
        )
    ...
    def test_profile_edit_post(self):
        ...
        response = self.client.post(
            reverse("myauth:profile_edit"), data, content_type="application/json"
        )
    ...
    def test_profile_password(self):
        data = {"passwordCurrent": "1", "password": "2", "passwordReply": "2"}

        response = self.client.post(
            reverse("myauth:profile_pass"), data=data, content_type="application/json"
        )
    ...
    def test_profile_password_false(self):
        data = {"passwordCurrent": "3", "password": "2", "passwordReply": "2"}
